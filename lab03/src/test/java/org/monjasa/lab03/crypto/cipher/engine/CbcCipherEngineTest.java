...
import org.monjasa.lab03.crypto.cipher.engine.buffered.impl.DefaultBufferedBlockCipherEngine;
...
class CbcCipherEngineTest {
    ...
    void testCipherEngine() throws InvalidCipherTextException {
        ...
        BufferedBlockCipherEngine cipherEngine = new DefaultBufferedBlockCipherEngine(new CbcCipherEngine(new Rc5CipherEngine()));
